...
void LCD_ESCRIBE_VAR_INT(unsigned int numero, unsigned char n_digitos){
    ...
    switch(n_digitos){
        case 0:
            if(d_millar == 0 && millar == 0 && centena == 0 && decena == 0){
                ENVIA_CHAR(unidad+0x30);
                ESCRIBE_MENSAJE2("    ");
            }
            else if(d_millar == 0 && millar == 0 && centena == 0 && decena != 0){
                ENVIA_CHAR(decena+0x30);
                ENVIA_CHAR(unidad+0x30);
                ESCRIBE_MENSAJE2("   ");
            }
            else if(d_millar == 0 && millar == 0 && centena != 0){
                ENVIA_CHAR(centena+0x30);
                ENVIA_CHAR(decena+0x30);
                ENVIA_CHAR(unidad+0x30);
                ESCRIBE_MENSAJE2("  ");
            }
            else if(d_millar == 0 && millar != 0){
