...
; CONFIG1H
  CONFIG FOSC = INTOSCCLKO ; Oscillator Selection (Internal oscillator, clock output on OSC2)
...
configuro: ;etiqueta configuro
    ...
    clrf ANSELD ;todo ((EECON1) and 0FFh), 0, a como digitales
    clrf TRISB ;todo RB como salidas
    clrf TRISD ;todo ((EECON1) and 0FFh), 0, a como salidas
...
; movlw 5AH
    xorlw 0FFH
    movwf LATD ;escribir 5AH en ((EECON1) and 0FFh), 0, a
