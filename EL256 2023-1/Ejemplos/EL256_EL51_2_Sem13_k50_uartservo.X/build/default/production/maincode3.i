...
void pantallazo(void){
    ...
    _delay((unsigned long)((3000)*(4000000UL/4000.0)));
    BORRAR_LCD();
}
...
void __attribute__((picinterrupt(("high_priority")))) INT0_EUSARTRX_ISR(void){
    if(INTCONbits.INT0IF == 1){
        ...
        for(x_var=0;x_var<50;x_var++){
            LATAbits.LA0 = 1;
            _delay((unsigned long)((700)*(4000000UL/4000000.0)));
            LATAbits.LA0 = 0;
            _delay((unsigned long)((19300)*(4000000UL/4000000.0)));
        }
        BORRAR_LCD();
    }
        ...
        switch(RCREG1){
            case 'P':
                EUSART_Stringsend("machucaste la P");
                EUSART_Newline();
                break;
            case 'E':
                EUSART_Stringsend("machucaste la E");
                EUSART_Newline();
                break;
            case 'R':
                EUSART_Stringsend("machucaste la R");
                EUSART_Newline();
                break;
            case 'U':
                EUSART_Stringsend("machucaste la U");
                EUSART_Newline();
                break;
            default:
                EUSART_Stringsend("tecla errada no te pases");
                EUSART_Newline();
                break;
        }
    }
...
void __attribute__((picinterrupt(("low_priority")))) INT1_ISR(void){
    ...
    for(x_var=0;x_var<50;x_var++){
        LATAbits.LA0 = 1;
        _delay((unsigned long)((2300)*(4000000UL/4000000.0)));
        LATAbits.LA0 = 0;
        _delay((unsigned long)((17700)*(4000000UL/4000000.0)));
    }
    BORRAR_LCD();
}
