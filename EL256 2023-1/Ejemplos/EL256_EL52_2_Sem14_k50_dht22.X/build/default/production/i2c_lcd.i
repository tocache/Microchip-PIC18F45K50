...
{
    char datos;
    if((nibble & 1)==1) datos = datos|0x10; else datos = datos&~0x10;
    if((nibble & 2)==2) datos = datos|0x20; else datos = datos&~0x20;
    if((nibble & 4)==4) datos = datos|0x40; else datos = datos&~0x40;
    if((nibble & 8)==8) datos = datos|0x80; else datos = datos&~0x80;
