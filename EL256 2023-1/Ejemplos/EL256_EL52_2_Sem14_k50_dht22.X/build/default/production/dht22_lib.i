...
void DHT22_Start(void){
    TRISAbits.RA0 = 0;
    LATAbits.LA0 = 0;
    _delay((unsigned long)((18)*(4000000UL/4000.0)));
    LATAbits.LA0 = 1;
    _delay((unsigned long)((40)*(4000000UL/4000000.0)));
    TRISAbits.RA0 = 1;
}

void DHT22_Check(void){
    while(PORTAbits.RA0);
    _delay((unsigned long)((80)*(4000000UL/4000000.0)));
    while(!PORTAbits.RA0);
    _delay((unsigned long)((80)*(4000000UL/4000000.0)));
    while(PORTAbits.RA0);
}
...
unsigned char DHT22_Read(void){
    ...
    for(x=0;x<8;x++){
        while(!PORTAbits.RA0);
        _delay((unsigned long)((35)*(4000000UL/4000000.0)));
        if(PORTAbits.RA0){
            data = ((data<<1) | 1);
        }
        else{
