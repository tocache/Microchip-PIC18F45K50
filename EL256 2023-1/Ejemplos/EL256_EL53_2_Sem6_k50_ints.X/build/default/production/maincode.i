...
configuro:
    ...
    movwf TRISA
    movwf ANSELA
    bcf INTCON2, 7 ;((INTCON2) and 0FFh), 7, a habilitado
    bsf TRISB, 0
    bcf ANSELB, 0
    bsf WPUB, 0
    bsf TRISB, 1
    ...
    bsf WPUB, 1
    ;conf de interrupts
    bsf RCON, 7 ;((RCON) and 0FFh), 7, a=1
    bsf INTCON, 7 ;((INTCON) and 0FFh), 7, a=1
    bsf INTCON, 6 ;((INTCON) and 0FFh), 6, a=1
    bsf INTCON, 4 ;((INTCON) and 0FFh), 4, a=1
    bsf INTCON3, 3 ;((INTCON3) and 0FFh), 3, a=1
    bcf INTCON2, 6 ;((INTCON2) and 0FFh), 6, a=0
    bcf INTCON2, 5 ;((INTCON2) and 0FFh), 5, a=0
    bcf INTCON3, 6 ;((INTCON3) and 0FFh), 6, a=0
...
INT0_ISR:
    bcf INTCON, 1 ;((INTCON) and 0FFh), 1, a=0
    movlw 9
...
INT1_ISR:
    bcf INTCON3, 0 ;((INTCON3) and 0FFh), 0, a=0
    movlw 0
